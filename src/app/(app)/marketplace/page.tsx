...
const allOffers = [
  ...
  },
  {
  ...
  },
   {
    id: 7,
    title: "Semrush",
    description: "by Semrush",
    category: "SaaS",
    payout: "40% Recurring Commission",
    geo: "Global",
    traffic: "SEO, Content, PPC",
  },
  {
    id: 8,
    ...
    payout: "$50 CPA",
    geo: "USA, CA, UK, AU",
    traffic: "Podcast, YouTube, Social",
  },
   {
    id: 9,
    title: "Binance",
    description: "by Binance",
    category: "Crypto",
    payout: "50% Trading Fee Share",
    geo: "Global (exc. USA)",
    traffic: "Community, Content",
  },
  {
    id: 10,
    title: "DraftKings",
    description: "by DraftKings",
    category: "Gambling",
    payout: "25% RevShare",
    geo: "USA (select states)",
    traffic: "Social, Email, PPC",
  },
  {
    id: 11,
    title: "Shopify",
    description: "by Shopify",
    category: "SaaS",
    payout: "200% Bounty per new merchant",
    geo: "Global",
    traffic: "Content, YouTube, Agencies",
  },
  {
    id: 12,
    title: "MyProtein",
    description: "by The Hut Group",
    category: "Health & Fitness",
    payout: "8% Commission",
    geo: "EU, UK, USA",
    traffic: "Social, Content",
  },
  {
    id: 13,
    title: "Coinbase",
    ...
    category: "Crypto",
    payout: "50% of referee's trading fees for 3 months",
    geo: "Global",
  ...
  },
  {
    ...
    description: "by Blizzard Entertainment",
    category: "Gaming",
    payout: "$25 CPA for new subscription",
    geo: "Global",
    traffic: "Twitch, YouTube, Community sites",
  },
  {
    id: 15,
    title: "QuickBooks",
    description: "by Intuit",
    category: "SaaS",
    payout: "10% Recurring Commission",
    geo: "USA, CA, UK, AU",
    traffic: "Content, Financial blogs, PPC",
  },
];
